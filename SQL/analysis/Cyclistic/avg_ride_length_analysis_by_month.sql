...
query computes the percentage difference between these averages, providing
insights into user behavior. The results offer valuable information for
optimizing bike-sharing services.
*/
